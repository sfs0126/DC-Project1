...
# removes stop words of a single row (cleaned_str/row/document)
...
#Parts of speech are also known as word classes or lexical categories. The
...
# lemmatization of a single Text (cleaned_str/row/document)
